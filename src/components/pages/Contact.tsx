    ...
    <section className="min-h-screen mt-16 md:mt-0 flex items-center justify-center bg-kindofwhite">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-2xl">
        <motion.div
          ...
          <motion.h2
            className="text-3xl sm:text-4xl lg:text-5xl font-futura font-bold text-black text-center mb-6 sm:mb-8"
            initial={{ opacity: 0 }}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <motion.button
              type="submit"
              className="ml-28 md:ml-44 py-3 px-6 bg-sexyblue text-kindofwhite rounded-lg font-futura text-lg hover:bg-capistor-600 transition-colors duration-200"
