      ...
      <div className="flex flex-col items-center space-y-4">
        <div className="w-16 h-16 bg-sexyblue/20 rounded-full flex items-center justify-center">
          <svg
            ...
            fill="currentColor"
            viewBox="0 0 24 24">
            <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505a3.017 3.017 0 0 0-2.122 2.136C.5 6.967.5 12 .5 12s0 5.033.505 5.814a3.016 3.016 0 0 0 2.122 2.136c1.872.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C23.5 17.033 23.5 12 23.5 12s0-5.033-.502-5.814zM9.545 15.568V8.432L15.818 12v1.568L9.545 15.568z" />
          </svg>
        </div>
