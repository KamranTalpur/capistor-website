          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            ...
            <motion.section
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 shadow-xl h-fit">
                <p
                  className="text-lg font-domine leading-relaxed"
                  style={{ color: "#222222" }}>
                  {summary}
                </p>
              </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    {skills.programming.map((skill, index) => (
                      <span
                        key={`prog-${index}`}
                        className="bg-sexyblue/30 text-sexyblue px-4 py-2 rounded-full text-sm font-domine font-medium">
                        {skill}
                      </span>
                    ))}
                    {/* Embedded Systems */}
                    {skills.embedded.map((skill, index) => (
                      <span
                        key={`emb-${index}`}
                        className="bg-sexyblue/20 text-sexyblue/80 px-4 py-2 rounded-full text-sm font-domine">
                        {skill}
                      </span>
                    ))}
                    ...
                    {skills.protocols.map((skill, index) => (
                      <span
                        key={`proto-${index}`}
                        className="bg-sexyblue/40 text-sexyblue px-4 py-2 rounded-full text-sm font-domine font-semibold">
                        {skill}
                      </span>
                    ))}
                    {/* Development Tools */}
                    {skills.tools.map((skill, index) => (
                      <span
                        key={`tool-${index}`}
                        className="bg-sexyblue/15 text-sexyblue/70 px-4 py-2 rounded-full text-sm font-domine">
                        {skill}
                      </span>
                    ))}
                    {/* Specialized Areas */}
                    {skills.specialized.map((skill, index) => (
                      <span
                        key={`spec-${index}`}
                        className="bg-sexyblue/35 text-sexyblue px-4 py-2 rounded-full text-sm font-domine font-medium">
                        {skill}
                      </span>
                    ))}
                  </div>
                    ...
                    <div
                      ...
                      <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start mb-6">
                        <div>
                          ...
                          <div className="text-sexyblue/60 mb-4 font-medium">
                            {job.duration}
                          </div>
                        </div>
                      ...
                      {job.description && (
                        <p
                          className="font-domine mb-6 italic text-lg"
                          style={{ color: "#222222" }}>
                          {job.description}
                        </p>
                      )}
                      ...
                      <ul className="space-y-3 mb-6">
                        {job.achievements.map((achievement, index) => (
                          <li key={index} className="flex items-start gap-3">
                            <span className="text-sexyblue mt-2 font-bold">
                              •
                            </span>
                            <span
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {awards.map((award, index) => (
                <div
                  ...
                  <div className="text-sexyblue/90 font-domine mb-2 font-semibold">
                    {award.issuer}
                  </div>
                  <div className="text-sexyblue/60 text-sm mb-4 font-medium">
                    {award.date}
                  </div>
                  <p
                    ...
                    <div
                      ...
                      <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start mb-6">
                        <div>
                          ...
                          {edu.location && (
                            <div className="text-sexyblue/70 mb-2">
                              {edu.location}
                            </div>
                          )}
                          <div className="text-sexyblue/60 mb-4 font-medium">
                        ...
                        <div className="flex flex-col gap-2">
                          <span
                            className={`px-4 py-2 rounded-full text-sm font-domine font-semibold ${
                              edu.type === "Degree"
                                ? "bg-sexyblue/30 text-sexyblue"
                                : edu.type === "Certificate"
                                ? "bg-green-400/20 text-green-700 border border-green-300/30"
                      ...
                      {edu.description && (
                        <p
                          className="font-domine mb-6 italic text-lg leading-relaxed"
                          style={{ color: "#222222" }}>
                          {edu.description}
                        </p>
                      )}
